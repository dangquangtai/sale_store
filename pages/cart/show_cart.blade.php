...
<body>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="index.html"><img src="{{ URL::to('public/frontend/images/home/logo.png') }}"
                                    alt="" /></a>
                        </div>
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                <li><a href="{{ URL::to('/login-checkout') }}"><i class="fa fa-user"></i> Account</a>
                                </li>
                               ...
                               $customer_id = Session::get('customer_id');
                                if ($customer_id){
                                    ...
                                    if ($shipping_id){
                                        ?>
                                <li><a href="{{ URL::to('/payment') }}"><i class="fa fa-crosshairs"></i> Payment</a>
                                    <?php 
                                    } else {
                                        ?>
                                ...
                                ?>
                                <li><a href="{{ URL::to('/logout-checkout') }}"><i class="fa fa-lock"></i> Logout</a>
                                </li>
                                <?php 
                                } else {
                                ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="cart_description">
                                <h4><a href="{{ URL::to('/chi-tiet-san-pham/' . $item->id) }}">{{ $item->name }}</a>
                                </h4>
                                <p>Web ID: 1089772</p>
                            </td>
                            <td class="cart_price">
                            ...
                            <td class="cart_quantity">
                                <form action="{{ URL::to('/update-cart-quantity') }}" method="post">
                                    ...
                                    &#160&#160<button type="submit" class="btn btn-default btn-sm">Edit</button>
                                </form>
                            </td>
                            <td class="cart_total">
    ...
    <script>
        $('.cart_quantity_up').click(function() {
            input_qty = $(this).next();
            soluong = parseInt(input_qty.val());
            if (soluong > 1) {
                soluong -= 1;
                input_qty.val(soluong);
            }
            return false;
        });
